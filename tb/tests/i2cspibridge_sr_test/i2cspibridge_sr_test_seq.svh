...
// File Name    :   i2cspibridge_sr_test_seq.svh
// Description  :   I2C-SPI Bridge SR Test Sequence
//-------------------------------------------------------------
`ifndef _I2CSPIBRIDGE_SR_TEST_SEQ_SVH
  `define _I2CSPIBRIDGE_SR_TEST_SEQ_SVH

class i2cspibridge_sr_test_seq extends i2cspibridge_base_seq;

  // Register with the factory
  `uvm_object_param_utils_begin(i2cspibridge_sr_test_seq)
  ...
  *************************************************************/
  function new(string name="i2cspibridge_sr_test_seq");
    super.new(name);
    `uvm_info("SR Test Seq","Constructor Done", UVM_HIGH)
  endfunction : new
  ...
  *************************************************************/
  task body();
    ...
    // c_py_final();
    `uvm_info("SR Test Seq","Body Done", UVM_HIGH)
  endtask : body

  
  
endclass : i2cspibridge_sr_test_seq

`endif // _I2CSPIBRIDGE_SR_TEST_SEQ_SVH