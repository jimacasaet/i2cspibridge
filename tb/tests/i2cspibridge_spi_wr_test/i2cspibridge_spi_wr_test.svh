...
class i2cspibridge_spi_wr_test extends i2cspibridge_base_test;

  // Instantiate Test Sequence
  rand i2cspibridge_spi_wr_test_seq spi_wr_test_seq;

  `uvm_component_utils_begin(i2cspibridge_spi_wr_test)
    `uvm_field_object(spi_wr_test_seq, UVM_ALL_ON)
  `uvm_component_utils_end

  /******************************************************************************
  *   FUNCTION: Constructor
  ******************************************************************************/
  function new(string name="i2cspibridge_spi_wr_test", uvm_component parent=null);
  ...
  ******************************************************************************/
  virtual task main_phase(uvm_phase phase);
    ...
    // Create the test seq
    spi_wr_test_seq = i2cspibridge_spi_wr_test_seq::type_id::create("spi_wr_test_seq", this);
...
endclass : i2cspibridge_spi_wr_test
`endif // _I2CSPIBRIDGE_SPI_WR_TEST_SVH
