...
// File Name    :   i2c_master_agent_config.svh
// Description  :   I2C Agent Configuration Object
//-------------------------------------------------------------
`ifndef _I2C_MASTER_AGENT_CONFIG_SVH
  `define _I2C_MASTER_AGENT_CONFIG_SVH

class i2c_master_agent_config extends i2c_agent_config;
  `uvm_component_param_utils(i2c_master_agent_config)

  /************************************************************
  *   FUNCTION: Constructor
  *************************************************************/
  function new(string name="i2c_master_agent_config", uvm_component parent=null);
...
`endif //_I2C_MASTER_AGENT_CONFIG_SVH