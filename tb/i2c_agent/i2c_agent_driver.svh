...
// File Name    :   i2c_agent_driver.svh
// Description  :   I2C Agent Driver
//-------------------------------------------------------------
`ifndef _I2C_AGENT_DRIVER_SVH
  `define _I2C_AGENT_DRIVER_SVH

class i2c_agent_driver#(
  ...
  `uvm_component_param_utils(i2c_agent_driver#(SIGNAL_WIDTH, N_SIGNAL, SEQ_ITEM_T))
  ...
  *************************************************************/
  function new(string name="i2c_agent_driver", uvm_component parent=null);
...
endclass : i2c_agent_driver

`endif //_I2C_AGENT_DRIVER_SVH